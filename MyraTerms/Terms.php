        ...
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <form action="">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="sectionNumber">Sub-Section</label> <!--buat dropdown-->
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="sectionTitleMalay">Terms (Malay)</label>
                    <input type="text" class="form-control" id="sectionTitleMalay" nama="sectionTitleMalay">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="sectiontitleEnglish">Terms (English)</label>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea name="desc" id="myTextarea"></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
            ...
            <div class="card" style="width:1250px">
              <div class="card-header">
                <h3 class="card-title">Data All Terms</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>-</td>
                    <td>U</td>
                    <td><button type="button" class="f" style="margin-left:20%"><i class="fas fa-edit"></i></button> <button type="button" class="f"><i class="fas fa-eraser"></i></button></td>
                  </tr>
                  </tbody>
                  <tfoot>
                  <tr>
