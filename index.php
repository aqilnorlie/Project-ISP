...
<!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <img  src="dist/img/UitmPahang.png" alt="AdminLTELogo" height="auto" width="40%">
  </div>
  <!-- Navbar -->
  <div class="navbar">
    <a  class="logIn" href="MyraLogin/login.php">Login</a>
  </div>
  <!-- /.navbar -->
            ...
            <section class="content" style= "padding-top: 1px;">
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST'){
                  ...
                  if($_POST['keyword'] != null)
                  {
                    ...
                    $stmtkeyword = $conn1->prepare($sqlkeyword);
                    $datakeyword = [
              ...
              <!-- /.card-header -->
              <div class="card-body table1 card col-xl-20">
                    ...
                    <table id="example2" class="table table-bordered table-hover table2">
                      ...
                      <tbody>
                        <?php 
                         $sqlsearch = "SELECT s.sectionNumber, s.sectionTitleMalay, s.sectionTitleEnglish, ss.subSectionTitleMalay, ss.subSectionTitleEnglish, t.termTitleMalay, t.termTitleEnglish, t.token, s.dataStatusId, t.dataStatusId, ss.dataStatusId
                         FROM 
                             myraterm t 
                         JOIN 
                         ...
                         WHERE 
                             (t.termTitleMalay REGEXP '$newkeyword' OR t.termTitleEnglish REGEXP '$newkeyword') 

                         and (t.dataStatusId = '1' AND s.dataStatusId = '1' AND ss.dataStatusId = '1')";

       
       
                         $stmtsearch = $conn1->prepare($sqlsearch);
                         $stmtsearch->execute();
                  ...
                  { ?>
                        ...
                        <form action="MyraSearch/viewsearch.php?searchToken=<?= $test['token']; ?>" method="post">
